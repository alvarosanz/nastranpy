...
card_interfaces = {
    ...
    'CBAR': class_factory('CBAR', Item.elem, [F(), F(), F(Item.prop.name, Item.prop), F('grids', Item.grid, seq_type=Seq.list, length=2, update_grid=True), F('X1', Item.grid, alternate_name='G0'), F('X2'), F('X3'), F('OFFT'),
                                              F('PA'), F('PB'), F('W1A'), F('W2A'), F('W3A'), F('W1B'), F('W2B'), F('W3B')], card_tag=Tag.e1D),
    'CBEAM': class_factory('CBEAM', Item.elem, [F(), F(), F(Item.prop.name, Item.prop), F('grids', Item.grid, seq_type=Seq.list, length=2, update_grid=True), F('X1', Item.grid, alternate_name='G0'), F('X2'), F('X3'), F('OFFT'),
